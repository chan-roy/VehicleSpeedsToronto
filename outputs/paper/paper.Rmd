---
title: "Speed limit compliance in Toronto residential streets is high, but speeding remains prevalent"
...
ggplot(wards) + 
  ...
  theme(axis.text.x = element_blank(), axis.text.y = element_blank(),
        ...
        plot.title = element_text(face = 'bold')) +
  facet_wrap(~ removal_date) +
  labs(title = 'Significant number of vehicles recorded exceeding the speed limit*',
